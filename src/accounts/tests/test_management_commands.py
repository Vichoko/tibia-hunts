...
class ManagementCommandTestCase(TestCase):
    ...
    def setUp(self):
        ...
        os.environ["GOOGLE_CLIENT_SECRET"] = "test-client-secret"  # noqa: S105
    ...
    def test_setup_oauth_command(self):
        ...
        assert app.secret == "test-client-secret"  # noqa: S105
    ...
    def test_cleanup_oauth_command(self):
        ...
        SocialApp.objects.create(
            ...
            name="Duplicate 1",
            client_id="old-id-1",
            secret="old-secret-1",  # noqa: S106
        )
        SocialApp.objects.create(
            provider="google",
            name="Duplicate 2",
            client_id="old-id-2",
            secret="old-secret-2",  # noqa: S106
        )

        # Verify duplicates exist
        assert SocialApp.objects.filter(provider="google").count() == 2
    ...
    def test_setup_oauth_command_missing_env_vars(self):
        ...
        try:
            ...
            _apps = SocialApp.objects.filter(provider="google")
